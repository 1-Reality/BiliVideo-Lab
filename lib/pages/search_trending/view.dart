...
import 'package:PiliBro/common/widgets/sliver/trending_header.dart';
import 'package:PiliBro/http/loading_state.dart';
import 'package:PiliBro/models_new/search/search_trending/list.dart';
import 'package:PiliBro/pages/search_trending/controller.dart';
...
class _SearchTrendingPageState extends State<SearchTrendingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final height = width * 528 * 0.0008888888888888889;
