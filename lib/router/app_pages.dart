import 'package:PiliBro/pages/article/view.dart';
import 'package:PiliBro/pages/article_list/view.dart';
...
import 'package:PiliBro/pages/dynamics_create_vote/view.dart';
import 'package:PiliBro/pages/dynamics_detail/view.dart';
import 'package:PiliBro/pages/dynamics_topic/view.dart';
import 'package:PiliBro/pages/dynamics_topic_rcmd/view.dart';
import 'package:PiliBro/pages/fan/view.dart';
import 'package:PiliBro/pages/fav/view.dart';
import 'package:PiliBro/pages/fav_create/view.dart';
import 'package:PiliBro/pages/fav_detail/view.dart';
import 'package:PiliBro/pages/fav_search/view.dart';
import 'package:PiliBro/pages/follow/view.dart';
import 'package:PiliBro/pages/follow_search/view.dart';
import 'package:PiliBro/pages/follow_type/follow_same/view.dart';
import 'package:PiliBro/pages/follow_type/followed/view.dart';
import 'package:PiliBro/pages/history/view.dart';
import 'package:PiliBro/pages/history_search/view.dart';
import 'package:PiliBro/pages/home/view.dart';
import 'package:PiliBro/pages/hot/view.dart';
import 'package:PiliBro/pages/later/view.dart';
import 'package:PiliBro/pages/later_search/view.dart';
import 'package:PiliBro/pages/live_dm_block/view.dart';
import 'package:PiliBro/pages/live_room/view.dart';
import 'package:PiliBro/pages/login/view.dart';
import 'package:PiliBro/pages/main/view.dart';
import 'package:PiliBro/pages/main_reply/view.dart';
import 'package:PiliBro/pages/match_info/view.dart';
import 'package:PiliBro/pages/member/view.dart';
import 'package:PiliBro/pages/member_dynamics/view.dart';
import 'package:PiliBro/pages/member_guard/view.dart';
import 'package:PiliBro/pages/member_profile/view.dart';
import 'package:PiliBro/pages/member_search/view.dart';
import 'package:PiliBro/pages/member_upower_rank/view.dart';
import 'package:PiliBro/pages/member_video_web/archive/view.dart';
import 'package:PiliBro/pages/member_video_web/season_series/view.dart';
import 'package:PiliBro/pages/msg_feed_top/at_me/view.dart';
import 'package:PiliBro/pages/msg_feed_top/like_detail/view.dart';
import 'package:PiliBro/pages/msg_feed_top/like_me/view.dart';
import 'package:PiliBro/pages/msg_feed_top/reply_me/view.dart';
import 'package:PiliBro/pages/msg_feed_top/sys_msg/view.dart';
import 'package:PiliBro/pages/music/view.dart';
import 'package:PiliBro/pages/my_reply/view.dart';
import 'package:PiliBro/pages/popular_precious/view.dart';
import 'package:PiliBro/pages/popular_series/view.dart';
import 'package:PiliBro/pages/search/view.dart';
import 'package:PiliBro/pages/search_result/view.dart';
import 'package:PiliBro/pages/search_trending/view.dart';
import 'package:PiliBro/pages/setting/pages/bar_set.dart';
import 'package:PiliBro/pages/setting/pages/color_select.dart';
import 'package:PiliBro/pages/setting/pages/cdn_settings.dart';
import 'package:PiliBro/pages/setting/pages/display_mode.dart';
...
import 'package:PiliBro/pages/setting/view.dart';
import 'package:PiliBro/pages/settings_search/view.dart';
import 'package:PiliBro/pages/space_setting/view.dart';
import 'package:PiliBro/pages/sponsor_block/view.dart';
import 'package:PiliBro/pages/subscription/view.dart';
import 'package:PiliBro/pages/subscription_detail/view.dart';
import 'package:PiliBro/pages/video/view.dart';
import 'package:PiliBro/pages/webview/view.dart';
import 'package:PiliBro/pages/whisper/view.dart';
import 'package:PiliBro/pages/whisper_detail/view.dart';
